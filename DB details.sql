...
INSERT INTO `alembic_version` VALUES ('52bda18e1b8b');
...
CREATE TABLE `marks` (
  ...
  `mid_fail` tinyint(1) NOT NULL,
  `backlog` tinyint(1) NOT NULL,
  `eligible_for_endsem` tinyint(1) DEFAULT NULL,
  ...
  CONSTRAINT `marks_ibfk_3` FOREIGN KEY (`uploaded_file_id`) REFERENCES `uploaded_files` (`id`)
...
INSERT INTO `marks` VALUES (1,1,'CS-401',15,18,16,38,85,87,4,2024,87.25,'low','2025-09-14 07:07:06',0,0,NULL,NULL),(2,7,'SC-401',2,8,15,1,NULL,26,4,2024,26.11,'high','2025-09-14 13:57:57',0,0,NULL,NULL),(3,7,'CS-402',15,8,17,29,NULL,69,4,2024,70.28,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(4,7,'CS-403',16,15,16,5,NULL,52,4,2024,49.17,'high','2025-09-14 13:57:57',0,0,NULL,NULL),(5,7,'CS-404',5,9,17,9,NULL,40,4,2024,40.56,'high','2025-09-14 13:57:57',0,0,NULL,NULL),(6,7,'CS-405',11,14,17,30,NULL,72,4,2024,73.06,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(7,7,'CS-406',18,18,17,37,NULL,90,4,2024,90,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(8,7,'CS-407',14,13,16,35,NULL,78,4,2024,79.17,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(9,7,'CS-408',17,17,17,36,NULL,87,4,2024,87.22,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(10,7,'CS-409',18,18,17,37,NULL,90,4,2024,90,'low','2025-09-14 13:57:57',0,0,NULL,NULL),(11,7,'HU-410',16,16,16,36,NULL,84,4,2024,84.44,'low','2025-09-14 13:57:57',0,0,NULL,NULL);
...
INSERT INTO `uploaded_files` VALUES (1,'4th_Sem_Semester','sem.xlsx','semester',1,'2025-09-14 07:47:17',NULL),(2,'4th_Sem_Semester','sem.xlsx','semester',1,'2025-09-14 07:48:45',NULL);
...
-- Dump completed on 2025-10-04 22:14:24
